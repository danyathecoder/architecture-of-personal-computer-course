...
;***************************** CODE SEGMENT ********************************************
CODE_RM segment para use16 ;выравниваем по границе параграфов, используя 16-битные регистры
...
DATA_BEGIN      = $
    ...
    MSG_HELLO_PM        db "wellcome in protected mode, press esc to come back to the real mode",0
